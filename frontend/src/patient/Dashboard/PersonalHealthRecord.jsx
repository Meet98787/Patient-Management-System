                ...
                <div className="grid grid-cols-1 md:grid-cols-8 gap-4 mt-3">
                    <div className="col-span-5 bg-white rounded-lg">
                        <div className="flex justify-between items-center px-2 py-2">
                            ...
                            <a href="#" className="text-blue-500 hover:text-blue-700 font-medium">View All History</a>
                        </div>
                        <hr />
                    ...
                    <div className="col-span-3 bg-white rounded-lg">
                        <div className="flex justify-between items-center px-2 py-2">
                            ...
                            <a href="#" className="text-blue-500">View All Prescriptions</a>
                        </div>
                        <hr />
                    ...
                    <div className="col-span-5 bg-white rounded-lg">
                        <div className="bg-white rounded-lg shadow-md p-4">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <a href="#" className="text-blue-500 font-medium hover:underline">View All Reports</a>
                            </div>
                        </div>

                        <div className="grid">
                            <div className="col-span-6">
                               <div className="box h-28 w-full rounded-lg bottom-1">
