                        ...
                        <div className="flex flex-col m-2">
                            ...
                            <div className='grid grid-cols-1 xl:grid-cols-4 gap-4 mb-4'>
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={specialty} onChange={(e) => setSpecialty(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={country} onChange={(e) => setCountry(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={state} onChange={(e) => setState(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={city} onChange={(e) => setCity(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={hospital} onChange={(e) => setHospital(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={doctor} onChange={(e) => setDoctor(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                <div className="relative border border-gray-300 rounded-md">
                                    ...
                                    <select value={appointmentType} onChange={(e) => setAppointmentType(e.target.value)} className="block w-full px-3 py-3 text-gray-500 bg-white border-0 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none">
                                ...
                                {!isAllSelected() ? (
                                    ...
                                    <>
                                        <div class="grid grid-cols-1 md:grid-cols-10 gap-4">
                                            <div class="col-span-7 p-3"><AppointmentTimeSlot /></div>
                                            ...
                                            <div class="col-span-3 px-2 py-3">
                                                <div className="bg-white w-full border-1 py-3 rounded-md">
                                                    ...
                                                    <div className="h-20 bg-custom-gradient m-2 rounded-md relative" >
                                                        <img src="./image/Patterns.png" alt="" className='w-28 absolute right-0 z-0' />
                                                        <div className='flex py-2 z-0'>
                                                            ...
                                                            <div>
                                                                ...
                                                                <button className='px-3 py-1 bg-btn-light rounded-full flex text-white'><img src="./image/vuesax.png" alt="" className='pe-1' /> Male</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className=' rounded-md bg-gray-100 p-3 mx-2'>
                                                        <div className="flex">
                                                            ...
                                                            <div className="col-span-5 p-2 px-1">
                                                                <div>
                                                                    <h6 className='text-gray-500 font-medium text' style={{ fontSize: '15px' }}>Years Of Experience</h6>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h6 className='text-gray-500 font-medium'>Emergency Contact Number</h6>
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className='text-black' style={{fontSize:'15px'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Lorem ipsum dolor sit amet, consectetur adipiscin.</p>
                                                        </div>
