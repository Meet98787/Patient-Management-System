                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center mb-3">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="relative w-72">
                        ...
                        <span className="absolute inset-y-0  pl-3 flex items-center text-gray-500" style={{ left: '-5px' }}>
                        ...
                        <input
                          type="text"
                          className="form-control " style={{ width: '270px' }} // pl-10 for left icon, pr-10 for right icon
                      ...
                      {allAppointment.map((val, index) => (
                        <div key={index} className="w-full rounded-lg bg-white border border-gray-200 shadow-md h-70">
                         ...
                         <div className='flex justify-between items-center'>
                           <button className='px-3 py-2 border-2 m-2'><i class="fa-solid fa-business-time text-gray-600"></i> Cancle</button>
                           <button className='px-3 py-2 rounded-lg m-2 bg-btn-bg text-white'><i class="fa-solid fa-business-time  "></i> Reschedule</button>
                         </div>
                        </div>
                      ))}
                    </div>
