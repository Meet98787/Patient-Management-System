...
const ProfileSetting = () => {
    return (
        <div className='bg-custom-gradient w-full h-52'>
            <div className="container mx-auto py-5">
                ...
                <div className="w-full bg-white shadow-lg rounded-lg flex flex-col md:flex-row ">
                    {/* Section 1 */}
                    <div className="w-full md:w-72 p-10 border-b md:border-b-0 md:border-r border-gray-300 flex flex-col items-center">
                        <img
                    ...
                    <div className="w-full p-6 ">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mb-3">
                            <div className="col-span-1">
                                <label htmlFor="firstName" className="block text-sm font-medium">Name</label>
                                <input
                                    type="text"
                            ...
                            <div className="col-span-1">
                                <label htmlFor="lastName" className="block text-sm font-medium">Number</label>
                                <input
                                    type="text"
                                    className="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                                    id="lastName"
                        ...
                        <div className="mb-6">
                            ...
                            <input type="text" className="mt-1 block w-full p-2 border border-gray-300 rounded-md" id="address" />
                        </div>

                        <div className="flex justify-end gap-4">
                            <button className="px-4 py-2 text-black rounded-md hover:bg-gray-400 font-semibold border-2">Cancel</button>
