    ...
    const description = [
        {
            ...
            lorem1: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus, voluptatibus hic. Repudiandae vel eaque mollitia molestiae at fugiat sed nesciunt! Maxime,',
            lorem2: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium tempora velit error nobis cum.'
        },
        {
                            ...
                            <div className="overflow-y-auto" style={{ height: '550px' }}>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    {allAppointment.map((val, index) => (
                                        <div key={index} className="w-full rounded-lg bg-white border border-gray-200 shadow-md h-70">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                {description.map((val, index) => (
                                    <div key={index} className="w-full rounded-lg bg-white border border-gray-200 shadow-md h-70">
                                        ...
                                        <div className='px-3'>
                                            <p><i className="fa-solid fa-circle pe-2" style={{fontSize:'6px'}}></i>{val.lorem1}</p>
                                            <p><i className="fa-solid fa-circle pe-2" style={{fontSize:'6px'}}></i>{val.lorem2}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
